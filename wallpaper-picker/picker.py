...
class WallpaperPicker(Gtk.ApplicationWindow):
    ...
    def _apply(self, w):
        ...
        def _post_matugen():
            ...
            if avg_sat < 0.12:
                # Achromatic/white/grey/black wallpaper — write neutral ZSH palette
                # and neutralize kitty background/foreground so the terminal doesn't
                # pick up matugen's arbitrary pink/blue tint.
